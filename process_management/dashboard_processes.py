...
def _create_and_run_dashboard(dashboard_settings : DashboardSettings, projector : Projector, plot_manger : ProjectorPlotManager):
    dashboard = Dashboard(dashboard_settings, projector, plot_manger)
